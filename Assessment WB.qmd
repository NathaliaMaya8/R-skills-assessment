---
title: R skills Assessment WB - Nathalia Maya Scarpeta
...
rmarkdown::paged_table(GDP_byregion)
...
rmarkdown::paged_table(aggregate_estimates)
```
# 3. Find outliers 
...
```{r message=FALSE, warning=FALSE}
   ...
   rmarkdown::paged_table(svy_2001_2010_lorenz )
```
...
rmarkdown::paged_table(gini_final)
```
